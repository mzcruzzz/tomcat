...
RUN wget --no-check-certificate https://dlcdn.apache.org/tomcat/tomcat-8/v8.5.77/src/apache-tomcat-8.5.77-src.tar.gz
RUN tar -zxvf apache-tomcat-8.5.77-src.tar.gz -C /opt/tomcat --strip-components=1
